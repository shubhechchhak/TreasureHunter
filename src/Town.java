...
public class Town {
    ...
    public boolean leaveTown() {
        ...
        if (canLeaveTown) {
            ...
            if (checkItemBreak() && !(mode.equals("es"))) {
    ...
    public void digForGold() {
        boolean hasShovel = shovelInKit();
        int addGold = (int) (Math.random() * 20) + 1;
        ...
        if (hasShovel) {
            if (alreadyDug) {
                ...
                if (rand == 1) {
                    printMessage = "You dug up " + addGold + " gold\n";
                    hunter.changeGold(addGold);
                } else {
    ...
    public void lookForTrouble() {
        ...
        if (Math.random() > noTroubleChance) {
            ...
            if (Math.random() > noTroubleChance) {
                ...
                printMessage += Colors.RED + "\nYou won the brawl and receive " + Colors.RED + Colors.YELLOW + goldDiff + Colors.RESET + Colors.RED + " gold." + Colors.RESET;
